...
/* this file has been modified, do not regenerate */

pub mod xlib {
    use xlib::{ Display, Drawable, Visual, Screen, Pixmap };
    use super::cairo_surface_t;
    ...
    extern "C" {
        ...
        pub fn cairo_xlib_surface_set_size(
                arg0: *mut cairo_surface_t,
                arg1: ::libc::c_int,
                arg2: ::libc::c_int);
        ...
        pub fn cairo_xlib_surface_get_display(
                arg0: *mut cairo_surface_t)
            -> *mut Display;

        pub fn cairo_xlib_surface_get_drawable(
                arg0: *mut cairo_surface_t)
            -> Drawable;

        pub fn cairo_xlib_surface_get_screen(
                arg0: *mut cairo_surface_t)
            -> *mut Screen;

        pub fn cairo_xlib_surface_get_visual(
                arg0: *mut cairo_surface_t)
            -> *mut Visual;

        pub fn cairo_xlib_surface_get_depth(
                arg0: *mut cairo_surface_t)
            -> ::libc::c_int;

        pub fn cairo_xlib_surface_get_width(
                arg0: *mut cairo_surface_t)
            -> ::libc::c_int;

        pub fn cairo_xlib_surface_get_height(
                arg0: *mut cairo_surface_t)
            -> ::libc::c_int;
    }
}
...
impl Union__cairo_path_data_t {
    pub fn header(&mut self) -> *mut Struct_Unnamed5 {
        unsafe { ::std::mem::transmute(self) }
    }
    pub fn point(&mut self) -> *mut Struct_Unnamed6 {
        unsafe { ::std::mem::transmute(self) }
    }
}
#[repr(C)]
...
pub type cairo_raster_source_acquire_func_t =
    ::std::option::Option<extern "C" fn
                              (arg1: *mut cairo_pattern_t,
                               ...
                               arg4: *const cairo_rectangle_int_t)
                              -> *mut cairo_surface_t>;
